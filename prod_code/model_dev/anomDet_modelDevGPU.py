...
df = pd.read_parquet('/homes/dkurtenb/projects/russat/data/MODEL_training_tle_data_outlier.parquet')
...
def build_anom_model(NORAD_ID_NUM):
    ...
    detector, anomalies, explanations, timestamps, anomaly_details = run_kan_anomaly_detection(
        orb_df,
        feature_names=feature_names,
        model_path="/homes/dkurtenb/projects/russat/output/anomaly_model_KAN_4year",
        should_train=True,
